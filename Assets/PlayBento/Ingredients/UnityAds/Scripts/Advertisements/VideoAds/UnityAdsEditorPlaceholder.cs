  ...
  using System.IO;
	...
	internal class UnityAdsEditorPlaceholder : MonoBehaviour {
		...
		public void init () {
			...
			blackTex.Apply();
			placeHolderLandscape = textureFromFile(Application.dataPath + "/PlayBento/Ingredients/UnityAds/Textures/test_unit_800.png");
      		placeHolderPortrait = textureFromFile(Application.dataPath + "/PlayBento/Ingredients/UnityAds/Textures/test_unit_600.png");
		}
