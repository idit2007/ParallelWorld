...
public class InstrutionTutorial : MonoBehaviour {
	...
	void Update()
	{
		if (TimeScore.currentStage == 0) {
			...
			} else if (LeaderBoard.pressStage == "2") {
			...
			} else if (LeaderBoard.pressStage == "3") {
			...
			} else if (LeaderBoard.pressStage == "4") {
			...
			} else if (LeaderBoard.pressStage == "5") {
